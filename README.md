...
![FastAPI docs](screenshots/docs-overview.png)

**SQL route — aggregation questions:**

![SQL response](screenshots/ask-sql.png)

**RAG route — semantic questions:**

![RAG response](screenshots/ask-rag.png)
